...
void ETH_BSP_Config(void)
{
  ...
  if (EthInitStatus == 0)
  {
    ...
    LCD_DisplayStringLine(Line7, (uint8_t*)"   Ethernet Init   ");
    LCD_DisplayStringLine(Line8, (uint8_t*)"      failed      ");
    while(1);
  }
...
static void ETH_MACDMA_Config(void)
{
  ...
  /* Configure Ethernet */
  EthInitStatus = ETH_Init(&ETH_InitStructure, DP83848_PHY_ADDRESS);//ÅäÖÃETH
}
...
void Eth_Link_ITHandler(uint16_t PHYAddress)
{
  ...
  if(((ETH_ReadPHYRegister(PHYAddress, PHY_MISR)) & PHY_LINK_STATUS) != 0)
  {
    ...
    if(EthLinkStatus != 0)
    {
      ...
      LCD_DisplayStringLine(Line7, (uint8_t*)"  Network Cable is  ");
      LCD_DisplayStringLine(Line8, (uint8_t*)"     unplugged      ");
    }
    else
    {
      /* Display message on the LCD */
      LCD_DisplayStringLine(Line7, (uint8_t*)"  Network Cable is  ");
      LCD_DisplayStringLine(Line8, (uint8_t*)"   now connected    ");
    }
#endif
  }
}
